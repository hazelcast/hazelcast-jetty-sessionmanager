...
public abstract class AbstractJettySecurityTest extends AbstractHazelcastSessionsTest {
    @Override
    protected WebContainerConfigurator<?> getWebContainerConfigurator() {
        return getJettyConfigurator("secureApp");
    }
    ...
    protected abstract WebContainerConfigurator<?> getJettyConfigurator(String appName);
}