...
public abstract class AbstractNonSerializableSessionTest extends AbstractHazelcastSessionsTest {
    ...
    public void testSerialization() throws Exception {
        ...
        assertEquals("true", executeRequest("putnonserializable", SERVER_PORT_1, cookieStore));

        assertEquals("value", executeRequest("verifynonserializable", SERVER_PORT_1, cookieStore));
    }
}