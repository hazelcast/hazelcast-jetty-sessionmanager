    ...
    implements SessionDataStore
{
        ...
        throws Exception
    {
        ...
        _context.run( () -> {
            try
            {
                ...
                String cacheId = getCacheKey( id );
                SessionData sd = sessionDataMap.get( cacheId );
                reference.set(sd);
            }
            catch (Exception e)
            {
    ...
    {
        String cacheId = getCacheKey( id );
        return sessionDataMap == null ? false : sessionDataMap.remove( cacheId ) != null;
    }
    ...
    {
        String cacheId = getCacheKey( id );
        this.sessionDataMap.put( cacheId, data);
    }
    ...
    {
        String cacheId = getCacheKey( id );
        return this.sessionDataMap.containsKey( cacheId );
    }
